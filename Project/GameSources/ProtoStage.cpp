...
namespace basecross {
	...
	void ProtoStage::OnCreate() {
		try {
			...
			auto moveFloor_port = AddGameObject<Port>(Vec3(1.0f, 0.1f, 1.0f), Vec3(0), Vec3(0.0f, -0.5f, 3.0f));
			...
			AddGameObject<Goal>(Vec3(0.7f,0.7f,0.7f), Vec3(0), Vec3(0.0f, 0.0f, 0.0f), moveFloor_port);
